      ...
      <tbody>
        ${candidatesList.map(candidate => `
          <tr>
            ...
            <td><span class="status-badge status-${candidate.status}">${candidate.status}</td></span>
            <td>
  ...
  modalBody.innerHTML = `
    ...
    <div class="candidate-detail-section">
      ...
      <div class="detail-grid">
        ...
        <div class="detail-item"><div class="detail-label">Status</div><div class="detail-value"><span class="status-badge status-${candidate.status}">${candidate.status}</div></div></span>
